...
h2 { border-bottom: 1px solid black; margin-bottom: 20px; color: #1897D4; }

.sect2 { margin-left: 20px; }
...
h1, h2, h3, #toctitle, .sidebarblock > .content > .title, h4, h5, h6 { font-family: "Helvetica", Helvetica, Arial, sans-serif; font-weight: lighter; font-style: normal; color: #222222; text-rendering: optimizeLegibility; margin-top: 0.5em; margin-bottom: 0.5em; line-height: 1.2125em; }
...
#toc { border-bottom: 0px solid #dddddd; padding-bottom: 1.25em; }
